...
const MyRecipie = ({title, description, photo, onClick, onClick2}) => {
    ...
    return(
        <div style={{width: '95%'}}>
            ...
            onClickButton1={() => {setVisible(false)}} 
            onClickButton2={() => {onClick2(); {setVisible(false)}}}/>
                ...
                <div style={{width: '100%', display: 'flex', flexDirection: 'row'}}>
                    ...
                    <div style={{width: '30%', marginLeft: '16px', flexDirection:'column', alignItems: 'center', display: 'flex'}}>
                        <div style={{fontSize:'61px', cursor: 'pointer', width: '61px'}}>
                            <IoTrashOutline onClick={() => {setVisible(true)}}/>
                        </div>
                        <div style={{width: '100%'}}>
